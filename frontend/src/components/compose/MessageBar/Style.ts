...
import { Button as antButton, Select, Upload } from 'antd';
import { shouldNotForwardPropsWithKeys } from '@utils/common';

export const UploadHideInline = styled(Upload)`
...
export const UploadInline = styled(Upload)<{ fileCounts: number }>`
	...
	&.ant-upload-wrapper
		...
		border: 1px solid ${Colors.gpt_white_2};
		color: ${Colors.white_1};
		background: ${Colors.gpt_black_4};
	}
...
export const SendIcon = styled.div
	...
	& span:hover {
		fill: ${Colors.figma_green_3} !important;
	}
...
export const PromptIconBtn = styled(antButton)`
	background: none !important;
	border: none !important;
	min-width: 0 !important;
	padding: 0px;
...
export const UploadScroll = styled(Upload)<{ fileCounts: number }>`
	&.ant-upload ant-upload-select {
		width: 100%;
	}
	&.ant-upload-wrapper .ant-upload-list {
		...
		&::-webkit-scrollbar {
			background-color: ${Colors.figma_white_4};
		}
		&::-webkit-scrollbar,
		&::-webkit-scrollbar-thumb {
			width: 7px;
